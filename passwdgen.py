print("Skrypt generuje hasło na podstawie podanego słowa, zamieniając niektórę litery na cyfry lub znaki specjalne w taki sposób aby było silne oraz łatwę do zapamiętania")
print("Dla wzmocnienia hasła można dodać cyfry na początku - zostaną one odcielone "." od głownej części hasła")
print("oraz użyć na koncu losowego znaku specjalnego "." "?" lub "!" ")
import random
import string
